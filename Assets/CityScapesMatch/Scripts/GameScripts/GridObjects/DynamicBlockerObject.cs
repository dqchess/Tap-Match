...
namespace Mkey
{
    ...
    {
        #region properties
        public DynamicBlockerData OData { get; private set; }
        ...
        #region create
        internal virtual void SetData(DynamicBlockerData mData)
        {
            OData = mData;
            SetToFront(false);
        }
        ...
        /// <returns></returns>
        public static DynamicBlockerObject Create(GridCell parent, DynamicBlockerData oData, bool addCollider, bool isTrigger, Action<int> TargetCollectEvent)
        {
